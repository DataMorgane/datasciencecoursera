---
title: "Timeline and consequences of the major natural disasters in the USA from 1996 to 2011"
...
The next step is to re-assign the events types. There are indeed `r length(levels(data_1996$EVTYPE))` different categories (EVTYPE) of natural disasters in this dataset. The goal here is to reduce this number by grouping similar events.
...
```{r, cache=TRUE, fig.height=13, fig.width=13, dev='svg'}
